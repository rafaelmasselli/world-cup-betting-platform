...
import usersAvatarExempleImg from "../assets/usersAvatar.png";
...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      alert(
        "Bolão criado com sucesso, o código foi copiado para area de transferência"
      );
      setPool("");
    } catch (err) {
      console.log(err);
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares exibindo uma previa da aplicão mobile do nlw copa"
        quality={100}
      />
    </div>
  );
